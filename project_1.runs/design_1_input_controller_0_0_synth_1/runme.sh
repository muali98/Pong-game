...
HD_PWD='C:/Users/Ali/Pictures/Xilinx/new/pong_game/project_1.runs/design_1_input_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_input_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_input_controller_0_0.tcl
