...
# module references:
# input_controller, input_controller, inv, score_7seg, vga_controller
...
proc create_root_design { parentCell } {
  ...
  # Create instance: input_controller_1, and set properties
  set block_name input_controller
  set block_cell_name input_controller_1
  if { [catch {set input_controller_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $input_controller_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: score_7seg_0, and set properties
  set block_name score_7seg
  set block_cell_name score_7seg_0
  if { [catch {set score_7seg_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $score_7seg_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create port connections
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins score_7seg_0/score]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_pins axi_gpio_3/gpio_io_o] [get_bd_pins vga_controller_0/ball_pos]
  connect_bd_net -net axi_gpio_4_gpio_io_o [get_bd_pins axi_gpio_4/gpio_io_o] [get_bd_pins vga_controller_0/paddle_pos]
  connect_bd_net -net axi_uartlite_0_tx [get_bd_ports uart_tx] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net btn_down_0_1 [get_bd_ports btn_up] [get_bd_pins input_controller_0/btn_down]
  connect_bd_net -net btn_down_1_1 [get_bd_ports btn_left] [get_bd_pins input_controller_1/btn_down]
  connect_bd_net -net btn_up_0_1 [get_bd_ports btn_right] [get_bd_pins input_controller_0/btn_up]
  connect_bd_net -net btn_up_1_1 [get_bd_ports btn_down] [get_bd_pins input_controller_1/btn_up]
  connect_bd_net -net clk_100MHz_1 [get_bd_ports clk_100MHz] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins input_controller_0/clk] [get_bd_pins input_controller_1/clk] [get_bd_pins score_7seg_0/clk] [get_bd_pins vga_controller_0/clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_100M/dcm_locked]
  connect_bd_net -net input_controller_0_paddle_pos [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins input_controller_0/paddle_pos]
  connect_bd_net -net input_controller_1_paddle_pos [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins input_controller_1/paddle_pos]
  connect_bd_net -net inv_0_o_rst [get_bd_pins inv_0/o_rst] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_0_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  connect_bd_net -net reset_rtl_0_0_1 [get_bd_ports reset_rtl_0_0] [get_bd_pins clk_wiz_0/reset] [get_bd_pins input_controller_0/reset] [get_bd_pins input_controller_1/reset] [get_bd_pins inv_0/i_rst] [get_bd_pins score_7seg_0/reset] [get_bd_pins vga_controller_0/reset]
  ...
  connect_bd_net -net score_7seg_0_an [get_bd_ports an] [get_bd_pins score_7seg_0/an]
  connect_bd_net -net score_7seg_0_seg [get_bd_ports seg] [get_bd_pins score_7seg_0/seg]
  ...
  connect_bd_net -net vga_controller_0_rgb [get_bd_ports rgb] [get_bd_pins vga_controller_0/rgb]
