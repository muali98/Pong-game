...
HD_PWD='C:/Users/Ali/Pictures/Xilinx/pong_game/mine_made/input_controller/input_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_input_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_input_controller.tcl
