...
HD_PWD='C:/Users/Ali/Pictures/Xilinx/pong_game/mine_made/input_controller/input_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_input_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_input_controller.tcl -notrace
