...
HD_PWD='C:/Users/Ali/Pictures/Xilinx/pong_game/mine_made/7seg/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_score7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_score7seg.tcl -notrace
