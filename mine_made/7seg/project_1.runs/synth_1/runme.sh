...
HD_PWD='C:/Users/Ali/Pictures/Xilinx/pong_game/mine_made/7seg/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_score7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_score7seg.tcl
